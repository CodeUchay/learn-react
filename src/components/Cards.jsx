...
const Cards = () => {
  return (
    <div className=' w-full py-[10rem] px-10  bg-[#121212] text-gray-300'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='border border-secondary-500  w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
          ...
          {/* bg-[#ffa8e03a] */}
          <div className=' w-full shadow-xl bg-[#ff12ac3a] flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
