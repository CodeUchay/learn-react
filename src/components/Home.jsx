...
const Home = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#121212]">
      <nav className="fixed py-2 mx-auto lg:px-16 border text-gray-300 border-[#33353F] bg-[#121212] top-0 left-0 right-0 z-10 bg-opacity-100 ">
        ...
        <button onClick={() => {scrollToSection('section3'); setNavbarOpen(!navbarOpen)}} >About</button>
                <button onClick={() => {scrollToSection('section2'); setNavbarOpen(!navbarOpen)}} >Subscribe</button>
                <button onClick={() => {scrollToSection('section4'); setNavbarOpen(!navbarOpen)}} >Contact</button>
      </div>) : null}
      </nav>
